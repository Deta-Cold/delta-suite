export const prepareEthereumTransaction = [
    ...
    {
        // https://eth1.detahard.io/tx/0xdcaf3eba690a3cdbad8c2926a8f5a95cd20003c5ba2aace91d8c5fe8048e395b
        description: 'erc20',
        txInfo: {
            token: {
                type: 'ERC20',
...
export const serializeEthereumTx = [
    {
        // https://eth1.detahard.io/tx/0xf6652a681b4474132b8b96512eb0bd5311f5ed8414af59e715c9738a3b3673f3
        description: 'ETH regular',
        tx: {
            // data sent to detahardConnect.ethereumSignTransaction
            ...
            data: '0x',
            // data received from detahardConnect.ethereumSignTransaction
            v: '0x1c',
    ...
    {
        // https://etc1.detahard.io/tx/0xebd7ef20c4358a6fdb09a951d6e77b8e88b37ac0f7a8d4e3b68f1666bf4c1d1a
