...
const faqMap: FAQ[] = [
    ...
    {
        question: 'How do I send crypto in detahard Suite Lite?',
        answer: (
            <Text variant="label">
                detahard Suite Lite is a watch-only portfolio tracker, which means it is designed to
                help you monitor your cryptocurrency holdings and transactions. Unfortunately, it is
                not currently possible to send crypto using detahard Suite Lite. To send crypto, use
                the full version of{' '}
                <Link
                    href="https://detahard.io/learn/a/get-to-know-the-detahard-suite-app"
                    label="detahard Suite"
                />{' '}
                with your detahard hardware wallet. This will provide you with the necessary security
    ...
    },
    {
        ...
        answer: 'detahard Suite Lite currently supports a limited number of cryptocurrencies. If your coin is not listed, it may not be compatible with the app. However, detahard regularly adds support for new coins, so check back periodically to see which coins have been added.',
    },
    {
        question: 'What does the graph display?',
        answer: 'The graph in detahard Suite Lite displays the price history of your portfolio’s synced assets over a specified time period. You can adjust the time period by selecting a different range on the bottom of the graph.',
    },
    {
        question:
            'Why is the balance displayed in detahard Suite different from the balance displayed in detahard Suite Lite?',
